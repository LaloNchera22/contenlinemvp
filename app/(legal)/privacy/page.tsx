...
export const metadata = { title: 'Aviso de privacidad — Dare' };
  ...
  return (
    <LegalShell title="Aviso de privacidad" updated="16 de junio de 2026">
      <section>
        ...
        <p>
          Dare (“la plataforma”) trata datos personales conforme al RGPD (UE) y a la
          Ley Federal de Protección de Datos Personales en Posesión de los Particulares
          (México).
        </p>
      </section>
      <section>
        <h2 className="text-lg font-semibold text-ink">2. Datos que recopilamos</h2>
      ...
      <section>
        <h2 className="text-lg font-semibold text-ink">4. Tus derechos (ARCO / RGPD)</h2>
        <p>
      ...
      <section>
        <h2 className="text-lg font-semibold text-ink">5. Conservación</h2>
        <p>
      ...
      <section>
        ...
        <p>Para ejercer tus derechos, escribe a privacidad@dare.example.</p>
      </section>
    </LegalShell>
  );
}
