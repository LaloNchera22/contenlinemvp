...
export const metadata = { title: 'Términos de servicio — AdieCoin' };
  ...
  return (
    <LegalShell title="Términos de servicio" updated="2 de agosto de 2026">
      <section>
        ...
        <p>
          AdieCoin ofrece dos modos de pago con tratamiento distinto:
        </p>
        <ul className="mt-2 list-disc space-y-1 pl-5">
          ...
          <li>
            ...
            tesorería de AdieCoin recibes un saldo interno en AUSD (unidad de cuenta pegada 1:1
            al USDC depositado) que se liquida off-chain. Mientras esos fondos permanecen en tu
            saldo, <strong>AdieCoin los mantiene en custodia</strong> en su tesorería. Puedes
      ...
      <section>
        ...
        <p>
          Al operar un saldo custodiado y liquidar transferencias de valor, AdieCoin puede
