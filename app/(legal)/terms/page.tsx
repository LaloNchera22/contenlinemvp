  ...
  return (
    <LegalShell title="Términos de servicio" updated="16 de junio de 2026">
      <section>
        ...
        <p>
          AdieCoin es un protocolo <strong>non-custodial</strong>. Los pagos se ejecutan
      ...
      <section>
        ...
        <p>
          Al no custodiar fondos ni intermediar pagos, AdieCoin no opera como Institución de
