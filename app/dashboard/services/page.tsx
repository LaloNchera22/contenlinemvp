...
export default function ServicesPage() {
  ...
  return (
    <div className="max-w-3xl">
      ...
      <p className="text-muted text-sm mt-1">Ofrece servicios puntuales (consultorías, sesiones, etc.).</p>
      ...
      <div className="mt-6 space-y-2">
        {loading ? (
          ...
          <div className="card text-center py-10">
            ...
            <p className="text-sm text-muted mt-1">Crea tu primer servicio para ofrecerlo a tu audiencia.</p>
          </div>
        ) : (
          services.map((s) => (
            <div key={s.id} className="card flex items-center justify-between gap-3">
              ...
              <div className="flex gap-2 shrink-0">
                ...
                <button onClick={() => setToDelete(s)} disabled={busy} className="btn-ghost text-status-danger">
                  Eliminar
                </button>
              </div>
            </div>
